...
SECRET_KEY = '6iasad2v^j&&wkd47%7ggmi=#k7mw^i=h+pqh*hxr_bint@)-j' # Consider using your secret key
...
INSTALLED_APPS = [
    ...
    # My Apps
    'studentManagementApp.apps.StudentmanagementappConfig'
]
...
MIDDLEWARE = [
    ...
    # My Middleware
    'studentManagementApp.middleware.LoginCheckMiddleWare',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['studentManagementApp/templates'], #My App Templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
